...
def load_classification_dataset():
    ...
    for i in range(1, 26):  # Assuming 25 images for biryani
        ...
        image = ...  # Load image using appropriate method (e.g., cv2.imread)
        biryani_images.append(image)
    
    # Load aloo paratha images
    for i in range(1, 26):  # Assuming 25 images for aloo paratha
        image_path = f'C:\\Users\\rahul\\Desktop\\TDL_Project\\Dataset\\Aloo_Paratha\\aloo_{i}.jpg'
        image = ...  # Load image using appropriate method (e.g., cv2.imread)
    ...
    labels = np.array([0] * 25 + [1] * 25)  # Assuming 0 for biryani and 1 for aloo paratha
